...
import { SushiCareerJobClientProps, SushiCareerJobState } from './SushiCareerJobTypes'
import { formatDateTime, getStoreImages } from './SushiCareerJobUtils'
import { SLIDE_INTERVAL } from './SushiCareerJobConstants'
...
export default function SushiCareerJobClient({ params }: SushiCareerJobClientProps) {
  const router = useRouter()
  const [state, setState] = useState<SushiCareerJobState>({
    loading: true,
    jobId: '',
    job: null,
    company: null,
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <h1 className="text-xl font-bold text-white flex items-center gap-3">
                <img 
                  src="/sushicareer_logo_wh.png" 
                  alt="SushiCareer Logo" 
